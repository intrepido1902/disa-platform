...
export const Nav = ({ onCotizarClick }: NavProps) => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-5 md:px-10 lg:px-20 flex items-center justify-between">

          {/* Logo */}
          <Link href="/" className="relative z-10 flex-shrink-0">
            <div className={`relative transition-all duration-500 ${isScrolled ? "h-10 w-36" : "h-14 w-44"}`}>
              <Image
              ...
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className={`relative text-[10px] font-bold uppercase tracking-[0.35em] transition-colors duration-300 group cursor-pointer ${
                      isScrolled
                        ? "text-disa-blue hover:text-disa-gold"
                        : "text-white hover:text-disa-gold"
                    }`}
                  >
                    {link.label}
          ...
          <button
            ...
            className={`lg:hidden flex flex-col gap-[5px] p-2 transition-colors ${
              isScrolled ? "text-disa-blue" : "text-white"
            }`}
            aria-label="Menú"
          ...
          >
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/40 hover:text-disa-gold transition-colors text-[10px] tracking-[0.3em] uppercase font-bold"
              >
                @disa.textil
              </a>
            </motion.div>
